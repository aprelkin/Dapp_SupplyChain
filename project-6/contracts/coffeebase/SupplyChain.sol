...
contract SupplyChain is Ownable, ConsumerRole, RetailerRole, DistributorRole, FarmerRole {
  ...
  modifier checkValue(uint _upc)  {
    ...
    address payable addr = _make_payable(items[_upc].consumerID);
  ...
  function harvestItem(uint _upc, address _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string memory _originFarmLatitude, string memory _originFarmLongitude, string memory _productNotes) public
  {
    ...
    itemsHistory[_upc].push("Item harvested");
  ...
  verifyCaller(items[_upc].originFarmerID)
  {
    ...
    itemsHistory[_upc].push("Item processed");
  ...
  verifyCaller(items[_upc].originFarmerID)
  {
    ...
    itemsHistory[_upc].push("Item packed");
    emit Packed(_upc);
  ...
  verifyCaller(items[_upc].originFarmerID)
  {
    ...
    itemsHistory[_upc].push("Item listed for sale");
  ...
  checkValue(_upc)
  {
    ...
    address previousOwner = items[_upc].ownerID;
    // Update the appropriate fields - ownerID, distributorID, itemState
    items[_upc].ownerID = msg.sender;
    items[_upc].distributorID = msg.sender;
    items[_upc].itemState = State.Sold;
    address payable addr = _make_payable(previousOwner);
    ...
    //verifyCaller(items[_upc].retailerID)
  {
    ...
    itemsHistory[_upc].push("Item received");
    emit Received(_upc);
    // Emit the appropriate event
  }
    ...
    // Access Control List enforced by calling Smart Contract / DApp
  {
    ...
    itemsHistory[_upc].push("Item purchased");
    emit Purchased(_upc);
